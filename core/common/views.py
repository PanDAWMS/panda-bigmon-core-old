...
def listJobs(request):
    ...
    if request.META.get('CONTENT_TYPE', 'text/plain') == 'text/plain':
        ...
        data.update(getContextVariables(request))
        return render_to_response('core/list_jobs.html', data, RequestContext(request))
...
def jobDetails(request, pandaid):
    ...
    if request.META.get('CONTENT_TYPE', 'text/plain') == 'text/plain':
        ...
        data.update(getContextVariables(request))
        return render_to_response('core/details_job.html', data, RequestContext(request))
    elif request.META.get('CONTENT_TYPE', 'text/plain') == 'application/json':
...
def jobInfoDefault(request):
        ...
        data.update(getContextVariables(request))
        return render_to_response('core/msg.html', data, RequestContext(request))
...
def jobInfo(request, prodUserName, ndays):
    ...
    data.update(getContextVariables(request))
    return render_to_response('core/info_jobs.html', data, RequestContext(request))
...
def list3PandaJobs(request):
    ...
    data.update(getContextVariables(request))
    return render_to_response('core/list3.html', data, RequestContext(request))
